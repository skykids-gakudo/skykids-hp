  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-4 z-50 animate-gentle-bounce"
        aria-label="LINEでお気軽にご相談ください"
      >
        <span className="flex items-center gap-2 bg-[#06C755] text-white text-xs font-bold pl-4 pr-2 py-2 rounded-full shadow-lg hover:bg-[#05b04c] transition-colors">
          お気軽にご相談ください
